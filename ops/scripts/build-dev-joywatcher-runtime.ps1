# Build JoyWatcher runtime driver EXE (debug) and install it under driver-ui/joywatcher/
# Usage: .\scripts\build-dev-joywatcher-runtime.ps1
...
try {
    cargo build --manifest-path apps/joywatcher/driver/Cargo.toml
...
Write-Host ">>> done: driver-ui/joywatcher/driver-joywatcher.exe installed"
